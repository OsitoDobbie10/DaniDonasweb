...
export const v = {
  ...
  Atencion:FaSms,
  Listado:FaRegChartBar,
  Comida: BiCheese,
  Locacion:BiCurrentLocation,
  FlechaBoton:BiChevronsDown,
  LOGOWHATS: BiLogoWhatsapp,
  PEDIDO:BiBell,
  HOME:BiHomeAlt,
  FAVORITO:BiHeart,
  Menu:BiMenu,
  Mensage:BiMessageRoundedDetail,
  Cara:BiMeh,
  CloseView:AiFillEyeInvisible,
